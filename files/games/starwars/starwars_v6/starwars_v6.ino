...
void funcaoJogo(){
  ...
  if(rand_num1 == NAVE_ESPECIAL1 || rand_num2 == NAVE_ESPECIAL2){
    rand_num1 = NAVE_ESPECIAL1;
    rand_num2 = NAVE_ESPECIAL2;
  }  
  if(rand_num1 == NAVE_ESPECIAL2 || rand_num2 == NAVE_ESPECIAL1){
    rand_num1 = NAVE_ESPECIAL2;
    rand_num2 = NAVE_ESPECIAL1;
  }  
