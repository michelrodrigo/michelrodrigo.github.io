  ...
  switch(estado){
    ...
    case(jogo):
      ...
      if(pontoJ1 == PONTUACAO_MAXIMA){
        ...
        t.stop(evento_jogo);
        piscaPlacarJ1(8);
        evento_buzzer = t.oscillate(BUZZER, INTERVALO_PISCA_LED, LOW, 4); 
        evento_saida_led = t.oscillate(SAIDA_LED, INTERVALO_PISCA_LED, LOW, 4);
    ...
    case(fim_tempo):
      if(!inicializa_estado){
        ...
        if(pontoJ1 > pontoJ2){
          ...
          piscaTempo(8);
          evento_buzzer = t.oscillate(BUZZER, INTERVALO_PISCA_LED, LOW, 4);
          evento_pisca_led = t.oscillate(SAIDA_LED, INTERVALO_PISCA_LED, LOW, 4);
