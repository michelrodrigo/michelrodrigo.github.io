...
#define TEMPO_ALVO_LIGADO       2500 //tempo em que o alvo fica ligado
#define TEMPO_ENTRE_RODADAS     2600 //tempo entre duas rodadas. Esse valor deve ser maior que o TEMPO_ALVO_LIGADO
...
#define PONTUACAO_MAXIMA        20 // pontuação máxima que um jogador atinge para ganhar o jogo
  ...
  switch(estado){
    case(espera):
      if(!inicializa_estado){
        digitalWrite(SAIDA_LED1, LOW);
        digitalWrite(SAIDA_LED2, LOW);
...
void atualizaPlacarJ1(){
  if(rand_num1 == NAVE_ESPECIAL1 || rand_num1 == NAVE_ESPECIAL2){
...
void atualizaPlacarJ2(){
  if(rand_num2 == NAVE_ESPECIAL1 || rand_num2 == NAVE_ESPECIAL2){
