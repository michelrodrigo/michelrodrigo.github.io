...
var plants = new[] { M1, M2, M3,  M4, M5, M6}; // , , M4, M5, M6};
var specs = new[] {e1, e2, e3, e4}; //, e2, ,e3, e4 };

DeterministicFiniteAutomaton.ToWmodFile(@"D:\Dropbox\Doutorado\Plantas linqpad\ITL.wmod", plants, specs);
...
quantEspecification(out var Eq, "e11", 6);
